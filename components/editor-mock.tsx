...
className="win @container flex h-full w-full flex-col font-mono text-[8px] leading-[1.65] tracking-[-0.005em] text-code-fg sm:text-[9px] md:text-[10px]"
  >
  ...
  <span className="win-title">Claude Code · taskflow</span>
      </div>
