    ...
    <section id="harnesses">
      <div className="mx-auto w-full max-w-screen-2xl px-4 py-16 md:px-9 md:py-24">
        ...
        <div className="relative isolate mt-4 grid items-start gap-10 overflow-hidden bg-[url('/images/vscode-landscape.png')] bg-cover bg-center p-5 sm:p-7 lg:grid-cols-2 lg:gap-16 lg:p-8">
          <div className="max-w-xl overflow-hidden rounded-2xl border border-white/10 bg-[#111111]/70 p-5 shadow-[0_26px_60px_-18px_rgba(0,0,0,0.72),0_10px_24px_-12px_rgba(0,0,0,0.5),inset_0_1px_rgba(255,255,255,0.12),inset_0_-1px_rgba(255,255,255,0.03)] backdrop-blur-2xl backdrop-saturate-150 sm:p-6">
            <p className="text-balance font-mono text-2xl font-medium tracking-tight text-[#1c1a17] md:text-3xl">
              Conecta em qualquer ferramenta que você já usa.
            </p>
            <p className="mt-6 text-pretty leading-relaxed text-[#3d3a35]">
