          ...
          <Reveal delay={160}>
            <div className="mt-10 flex flex-wrap items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex h-11 items-center justify-center gap-2 rounded-[8px] border border-[#D3AF47] bg-[#D3AF47] px-5 font-mono text-sm text-[#090909] transition-opacity duration-200 hover:opacity-90 active:scale-[0.98]"
              >
                install
                <svg
                  aria-hidden="true"
