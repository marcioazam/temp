  ...
  return (
    <div className="flex items-stretch gap-3">
      ...
      <div className="flex items-stretch">
        <button
          type="button"
          className="type-micro inline-flex items-center whitespace-nowrap bg-foreground px-4 py-2.5 text-background transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
