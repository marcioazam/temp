...
export const metadata: Metadata = {
  title: "Docs — Nycode",
  description: "Documentação do Nycode: instalação, configuração de harnesses e uso do gateway de LLM.",
}
        ...
        <div className="min-w-0 flex-1 space-y-16">
          <section id="quickstart">
            ...
            <p className="mt-3 max-w-xl leading-relaxed text-muted-foreground">
              Tudo o que você precisa para conectar seu harness ao gateway Nycode.
            </p>
            ...
            <div className="mt-4">
              <CopyCommand command="npx nycode connect" />
            </div>
            <div className="mt-6 border border-border bg-card">
              ...
              <pre className="overflow-x-auto p-4 font-mono text-xs leading-relaxed text-foreground">
                <code>{`npm install -g nycode
nycode login
nycode connect --harness claude-code`}</code>
              </pre>
            </div>
          </section>
          ...
          <section id="modelos">
            ...
            <div className="mt-4 border border-border bg-card">
              <pre className="overflow-x-auto p-4 font-mono text-xs leading-relaxed text-foreground">
                <code>{`nycode models list
nycode models set-default anthropic/claude-sonnet
...
nycode usage`}</code>
          ...
          <section id="config">
            ...
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground">
              O arquivo <code className="bg-muted px-1 py-0.5 font-mono text-xs text-foreground">nycode.json</code>{" "}
